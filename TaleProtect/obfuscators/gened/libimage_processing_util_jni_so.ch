static inline __attribute__((always_inline)) unsigned char* decode_libimage_processing_util_jni_so__31(void){
    size_t __hc_len = 32u;
    ...
    __hc_tmpB = 0xD85B5A589A5B1959ULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
    ...
    __hc_tmpB = 0xFF48A126DF02DF4FULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
    ...
    __hc_tmpB = 0x9A5B1A5D7EF52C15ULL; __hc_tmpB = ((( ((( (__hc_tmpB ^ 0x0000000063A2F5CEULL) >> 56 ) | ( (__hc_tmpB ^ 0x0000000063A2F5CEULL) << 8 )) & 0xFFFFFFFFFFFFFFFFULL) << 2 ) | ( ((( (__hc_tmpB ^ 0x0000000063A2F5CEULL) >> 56 ) | ( (__hc_tmpB ^ 0x0000000063A2F5CEULL) << 8 )) & 0xFFFFFFFFFFFFFFFFULL) >> 62 )) & 0xFFFFFFFFFFFFFFFFULL);
    ...
    __hc_tmpB = 0x1BDCCB9A02D65376ULL; __hc_tmpB = ((( (__hc_tmpB + 0x0000000058C4444AULL) >> 6 ) | ( (__hc_tmpB + 0x0000000058C4444AULL) << 58 )) & 0xFFFFFFFFFFFFFFFFULL);
