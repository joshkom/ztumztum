static inline __attribute__((always_inline)) unsigned char* decode_libtoolChecker_so__17(void){
    ...
    __hc_tmpB = 0x1BDBDD189A5B10DBULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
    ...
    __hc_tmpB = 0xFF15B620DAF3F21AULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
