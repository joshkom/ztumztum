static inline __attribute__((always_inline)) unsigned char* decode_libstars_script_so__18(void){
    size_t __hc_len = 19u;
    ...
    __hc_tmpB = 0xA24FB42CE1F3DFE0ULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
