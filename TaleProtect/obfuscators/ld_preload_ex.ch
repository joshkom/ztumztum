...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_4c445f505245__11(void){
    size_t __hc_len = 11u;
    ...
    __hc_tmpB = 0x8C3BC4456FD21331ULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
    buf[8] = (unsigned char)((__hc_tmpB >> 0) & 0xFFULL);
    buf[9] = (unsigned char)((__hc_tmpB >> 8) & 0xFFULL);
    buf[10] = (unsigned char)((__hc_tmpB >> 16) & 0xFFULL);
    return buf;
}
static inline __attribute__((always_inline)) static inline size_t decode_4c445f505245__11_len(void){ return (size_t)11u; }