...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_2f646174612f__15(void){
    size_t __hc_len = 16u;
    ...
    __hc_tmpB = 0x8C4BA9319F00EE13ULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
...
static inline __attribute__((always_inline)) static inline size_t decode_2f646174612f__15_len(void){ return (size_t)15u; }