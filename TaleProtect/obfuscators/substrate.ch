...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_737562737472__9(void){
    size_t __hc_len = 10u;
    ...
    __hc_tmpB = 0x5C9D1CD89D5CDD18ULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
    ...
    __hc_tmpB = 0x8C3BC4456FD54F15ULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
    buf[8] = (unsigned char)((__hc_tmpB >> 0) & 0xFFULL);
    buf[9] = 0x0;
    return buf;
}
static inline __attribute__((always_inline)) static inline size_t decode_737562737472__9_len(void){ return (size_t)9u; }