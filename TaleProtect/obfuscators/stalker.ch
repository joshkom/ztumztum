...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_7374616c6b65__7(void){
    size_t __hc_len = 8u;
    ...
    __hc_tmpB = 0x995ADB185D1CC01CULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
...
static inline __attribute__((always_inline)) static inline size_t decode_7374616c6b65__7_len(void){ return (size_t)7u; }