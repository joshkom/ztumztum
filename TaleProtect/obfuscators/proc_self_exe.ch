...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_2f70726f632f__14(void){
    size_t __hc_len = 15u;
...
static inline __attribute__((always_inline)) static inline size_t decode_2f70726f632f__14_len(void){ return (size_t)14u; }