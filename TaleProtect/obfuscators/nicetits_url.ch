...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_68747470733a__34(void){
    size_t __hc_len = 35u;
    ...
    __hc_tmpB = 0x5D1958DA02C79790ULL; __hc_tmpB = ((( (__hc_tmpB + 0x0000000058C4444AULL) >> 6 ) | ( (__hc_tmpB + 0x0000000058C4444AULL) << 58 )) & 0xFFFFFFFFFFFFFFFFULL);
    ...
    __hc_tmpB = 0x4A2032CDBA28A659ULL; __hc_tmpB = ((((( __hc_tmpB >> 59 ) | ( __hc_tmpB << 5 )) & 0xFFFFFFFFFFFFFFFFULL) + 0x00000000A03E6ECFULL) ^ __hc_tmpA);
    buf[32] = (unsigned char)((__hc_tmpB >> 0) & 0xFFULL);
    buf[33] = (unsigned char)((__hc_tmpB >> 8) & 0xFFULL);
    buf[34] = 0x0;
    return buf;
}
static inline __attribute__((always_inline)) static inline size_t decode_68747470733a__34_len(void){ return (size_t)34u; }