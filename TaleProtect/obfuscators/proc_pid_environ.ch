...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_2f70726f632f__16(void){
    size_t __hc_len = 17u;
    ...
    __hc_tmpB = 0xE254B62CE5FEF1DFULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
...
static inline __attribute__((always_inline)) static inline size_t decode_2f70726f632f__16_len(void){ return (size_t)16u; }