static inline __attribute__((always_inline)) unsigned char* decode_libstars_so__11(void){
    size_t __hc_len = 12u;
    ...
    __hc_tmpB = 0x8C3BC4456FFFDFE0ULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
