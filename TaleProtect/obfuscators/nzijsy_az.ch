...
static inline __attribute__((always_inline)) unsigned char* decode_nzijsy_az__9(void){
    ...
    __hc_tmpB = 0x8C3BC4456FD54F2CULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
    buf[8] = (unsigned char)((__hc_tmpB >> 0) & 0xFFULL);
    buf[9] = 0x0;
    return buf;
}
static inline __attribute__((always_inline)) size_t decode_nzijsy_az__9_len(void){ return (size_t)9u; }