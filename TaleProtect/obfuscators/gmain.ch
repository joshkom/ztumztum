...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_676d61696e__5(void){
    size_t __hc_len = 6u;
    ...
    __hc_tmpB = 0x001B9A585B59C000ULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
...
static inline __attribute__((always_inline)) static inline size_t decode_676d61696e__5_len(void){ return (size_t)5u; }