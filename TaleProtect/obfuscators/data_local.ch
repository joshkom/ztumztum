...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_2f646174612f__12(void){
    size_t __hc_len = 13u;
    ...
    __hc_tmpB = 0x0BD85D18590BDBDBULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
    ...
    __hc_tmpB = 0x8C3BC4459F00EE13ULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
...
static inline __attribute__((always_inline)) static inline size_t decode_2f646174612f__12_len(void){ return (size_t)12u; }