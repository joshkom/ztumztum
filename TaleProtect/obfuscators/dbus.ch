...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_64627573__4(void){
    size_t __hc_len = 5u;
    ...
    __hc_tmpB = 0x00001CDD58990000ULL; __hc_tmpB = ((( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) << 36 ) | ( ((( __hc_tmpB >> 50 ) | ( __hc_tmpB << 14 )) & 0xFFFFFFFFFFFFFFFFULL) >> 28 )) & 0xFFFFFFFFFFFFFFFFULL);
...
static inline __attribute__((always_inline)) static inline size_t decode_64627573__4_len(void){ return (size_t)4u; }