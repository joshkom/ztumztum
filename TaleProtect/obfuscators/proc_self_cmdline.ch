...
#include <stdlib.h>
#include <stdio.h>
static inline __attribute__((always_inline)) unsigned char* decode_2f70726f632f__18(void){
    size_t __hc_len = 19u;
    ...
    __hc_tmpB = 0xE557A028D2BFF51EULL; __hc_tmpB = ((__hc_tmpB - 0x000000006F325DD1ULL) ^ __hc_tmpA);
    ...
    __hc_tmpB = 0x5B80000063A2F5D7ULL; __hc_tmpB = ((( ((( (__hc_tmpB ^ 0x0000000063A2F5CEULL) >> 56 ) | ( (__hc_tmpB ^ 0x0000000063A2F5CEULL) << 8 )) & 0xFFFFFFFFFFFFFFFFULL) << 2 ) | ( ((( (__hc_tmpB ^ 0x0000000063A2F5CEULL) >> 56 ) | ( (__hc_tmpB ^ 0x0000000063A2F5CEULL) << 8 )) & 0xFFFFFFFFFFFFFFFFULL) >> 62 )) & 0xFFFFFFFFFFFFFFFFULL);
    buf[16] = (unsigned char)((__hc_tmpB >> 0) & 0xFFULL);
    buf[17] = (unsigned char)((__hc_tmpB >> 8) & 0xFFULL);
    buf[18] = 0x0;
    return buf;
}
static inline __attribute__((always_inline)) static inline size_t decode_2f70726f632f__18_len(void){ return (size_t)18u; }